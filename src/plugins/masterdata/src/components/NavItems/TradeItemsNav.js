...
class _TradeItemsNav extends Component {
  goTo = path => {
    ...
    return (
      <Menu>
        ...
        <MenuItem
          text={pluginRegistry
            .getIntl()
            .formatMessage({id: "plugins.masterData.addTradeItem"})}
          onClick={this.goTo.bind(
            this,
            `/masterdata/add-trade-item/${server.serverID}`
          )}
        />
      </Menu>
    );
...
export const TradeItemsNav = withRouter(_TradeItemsNav);
